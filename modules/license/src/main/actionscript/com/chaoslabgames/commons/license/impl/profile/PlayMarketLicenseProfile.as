...
public class PlayMarketLicenseProfile extends EventDispatcher implements LicenseProfile {
    ...
    public function PlayMarketLicenseProfile(appKey:String,  appId:String) {
        this.appKey = appKey;
        this.appId = appId;
